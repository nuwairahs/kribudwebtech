...
const Process = () => {
  ...
  return (
    <div className="w-full font-inter flex justify-center bg-[#ffffff] py-20 p-10">
      <div className="max-w-[1200px] w-full  flex flex-col gap-10 items-center justify-center">
        <div className="w-8/12 max-lg:w-full">
          <h1 className="text-center text-4xl font-bold max-lg:text-2xl">
            From Vision to Reality: Our Seamless Web Development Process
          </h1>
        </div>
        <ul className="flex max-lg:flex-col gap-8 h-fit max-lg:h-fit max-lg:w-full mt-6 w-11/12 ">
          ...
          {webDevelopmentProcess.map((item) => {
            return (
              <li
                key={item.id}
                className="w-[20%] max-lg:w-full h-full flex flex-col  gap-10  rounded-xl bg-neutral-200 p-5"
              >
